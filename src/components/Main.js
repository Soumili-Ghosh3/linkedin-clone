    ...
    return (
            ...
            <Content>
...

                {
                    ...
                    <SocialActions>
                        <button>
                            <img src="/images/like-icon.png" alt="" width="20px" height="20px" />
                            <span> Like </span>
                        </button>

                        <button>
                            <img src="/images/comment-icon.png" alt="" width="20px" height="20px" />
                            <span> Comments </span>
                        </button>

                        <button>
                            <img src="/images/share-icon.png" alt="" width="20px" height="20px" />
                            <span> Share </span>
                        </button>

                        <button>
                            <img src="/images/send-icon.png" alt="" width="20px" height="20px" />
                            <span> Send </span>
                        </button>
                    </SocialActions>
